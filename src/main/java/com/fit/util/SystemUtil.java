...
public class SystemUtil {
	...
	// 操作系统的版本
	private static final String OS_VERSION = System.getProperty("os.version", null);
	// 操作系统的名称
	private static final String OS_NAME = System.getProperty("os.name", null);
	// 处理器架构
	private static final String OS_ARCH = System.getProperty("os.arch", null);
	// 用户的当前工作目录
	private static final String USER_DIR = System.getProperty("user.home", null);
	// 当前操作系统用户名
	private static final String USER_NAME = System.getProperty("user.name", null);
	// 项目部署路径
	private static final String ITEM_PATH = System.getProperty("user.dir", null);
	// 系统文件分隔符
	private static final String FILE_SEPARATOR = System.getProperty("file.separator", "/");
	// 系统换行符
	private static final String LINE_SEPARATOR = System.getProperty("line.separator", "\\n");
	// 系统路径分隔符
	private static final String PATH_SEPARATOR = System.getProperty("path.separator", null);
	// JAVA版本
	private static final String JAVA_VERSION = System.getProperty("java.version", null);

	private static final String COMPUTER_NAME = System.getenv().get("COMPUTERNAME");
	...
	public static Map<String, Object> getOsInfo() {
		...
		try {
			...
			map.put("mac", getLocalMac());// 获取本机网卡信息
			...
			map.put("sysTime", DateUtils.getDateNow());
