...
(function(e) {
    ...
    t.defaultOptions = {
        ...
        templates: {
            ...
            search: '<input type="search" class="input-text iconpicker-search" placeholder="Type to filter" />',
    ...
    t.defaultOptions = c.extend(t.defaultOptions, {
        icons: [
            {title: "x-icon icon-glass", searchTerms: []}, {title: "x-icon icon-music", searchTerms: []},
            {title: "x-icon icon-search", searchTerms: []}, {title: "x-icon icon-envelope", searchTerms: []},
            {title: "x-icon icon-heart", searchTerms: []}, {title: "x-icon icon-star", searchTerms: []},
            {title: "x-icon icon-star-empty", searchTerms: []}, {title: "x-icon icon-user", searchTerms: []},
            {title: "x-icon icon-film", searchTerms: []}, {title: "x-icon icon-th-large", searchTerms: []},
            {title: "x-icon icon-th", searchTerms: []}, {title: "x-icon icon-th-list", searchTerms: []},
            {title: "x-icon icon-ok", searchTerms: []}, {title: "x-icon icon-remove", searchTerms: []},
            {title: "x-icon icon-zoom-in", searchTerms: []}, {title: "x-icon icon-zoom-out", searchTerms: []},
            {title: "x-icon icon-off", searchTerms: []}, {title: "x-icon icon-signal", searchTerms: []},
            {title: "x-icon icon-cog", searchTerms: []}, {title: "x-icon icon-trash", searchTerms: []},
            {title: "x-icon icon-home", searchTerms: []}, {title: "x-icon icon-file", searchTerms: []},
            {title: "x-icon icon-time", searchTerms: []}, {title: "x-icon icon-road", searchTerms: []},
            {title: "x-icon icon-download-alt", searchTerms: []}, {title: "x-icon icon-download", searchTerms: []},
            {title: "x-icon icon-upload", searchTerms: []}, {title: "x-icon icon-inbox", searchTerms: []},
            {title: "x-icon icon-play-circle", searchTerms: []}, {title: "x-icon icon-repeat", searchTerms: []},
            {title: "x-icon icon-refresh", searchTerms: []}, {title: "x-icon icon-list-alt", searchTerms: []},
            {title: "x-icon icon-lock", searchTerms: []}, {title: "x-icon icon-flag", searchTerms: []},
            {title: "x-icon icon-headphones", searchTerms: []}, {title: "x-icon icon-volume-off", searchTerms: []},
            {title: "x-icon icon-volume-down", searchTerms: []}, {title: "x-icon icon-volume-up", searchTerms: []},
            {title: "x-icon icon-qrcode", searchTerms: []}, {title: "x-icon icon-barcode", searchTerms: []},
            {title: "x-icon icon-tag", searchTerms: []}, {title: "x-icon icon-tags", searchTerms: []},
            {title: "x-icon icon-book", searchTerms: []}, {title: "x-icon icon-bookmark", searchTerms: []},
            {title: "x-icon icon-print", searchTerms: []}, {title: "x-icon icon-camera", searchTerms: []},
            {title: "x-icon icon-font", searchTerms: []}, {title: "x-icon icon-bold", searchTerms: []},
            {title: "x-icon icon-italic", searchTerms: []}, {title: "x-icon icon-text-height", searchTerms: []},
            {title: "x-icon icon-text-width", searchTerms: []}, {title: "x-icon icon-align-left", searchTerms: []},
            {title: "x-icon icon-align-center", searchTerms: []}, {title: "x-icon icon-align-right", searchTerms: []},
            {title: "x-icon icon-align-justify", searchTerms: []}, {title: "x-icon icon-list", searchTerms: []},
            {title: "x-icon icon-indent-left", searchTerms: []}, {title: "x-icon icon-indent-right", searchTerms: []},
            {title: "x-icon icon-facetime-video", searchTerms: []}, {title: "x-icon icon-picture", searchTerms: []},
            {title: "x-icon icon-pencil", searchTerms: []}, {title: "x-icon icon-map-marker", searchTerms: []},
            {title: "x-icon icon-adjust", searchTerms: []}, {title: "x-icon icon-tint", searchTerms: []},
            {title: "x-icon icon-edit", searchTerms: []}, {title: "x-icon icon-share", searchTerms: []},
            {title: "x-icon icon-check", searchTerms: []}, {title: "x-icon icon-move", searchTerms: []},
            {title: "x-icon icon-step-backward", searchTerms: []}, {title: "x-icon icon-fast-backward", searchTerms: []},
            {title: "x-icon icon-backward", searchTerms: []}, {title: "x-icon icon-play", searchTerms: []},
            {title: "x-icon icon-pause", searchTerms: []}, {title: "x-icon icon-stop", searchTerms: []},
            {title: "x-icon icon-forward", searchTerms: []}, {title: "x-icon icon-fast-forward", searchTerms: []},
            {title: "x-icon icon-step-forward", searchTerms: []}, {title: "x-icon icon-eject", searchTerms: []},
            {title: "x-icon icon-chevron-left", searchTerms: []}, {title: "x-icon icon-chevron-right", searchTerms: []},
            {title: "x-icon icon-plus-sign", searchTerms: []}, {title: "x-icon icon-minus-sign", searchTerms: []},
            {title: "x-icon icon-remove-sign", searchTerms: []}, {title: "x-icon icon-ok-sign", searchTerms: []},
            {title: "x-icon icon-question-sign", searchTerms: []}, {title: "x-icon icon-info-sign", searchTerms: []},
            {title: "x-icon icon-screenshot", searchTerms: []}, {title: "x-icon icon-remove-circle", searchTerms: []},
            {title: "x-icon icon-ok-circle", searchTerms: []}, {title: "x-icon icon-ban-circle", searchTerms: []},
            {title: "x-icon icon-arrow-left", searchTerms: []}, {title: "x-icon icon-arrow-right", searchTerms: []},
            {title: "x-icon icon-arrow-up", searchTerms: []}, {title: "x-icon icon-arrow-down", searchTerms: []},
            {title: "x-icon icon-share-alt", searchTerms: []}, {title: "x-icon icon-resize-full", searchTerms: []},
            {title: "x-icon icon-resize-small", searchTerms: []}, {title: "x-icon icon-plus", searchTerms: []},
            {title: "x-icon icon-minus", searchTerms: []}, {title: "x-icon icon-asterisk", searchTerms: []},
            {title: "x-icon icon-exclamation-sign", searchTerms: []}, {title: "x-icon icon-gift", searchTerms: []},
            {title: "x-icon icon-leaf", searchTerms: []}, {title: "x-icon icon-fire", searchTerms: []},
            {title: "x-icon icon-eye-open", searchTerms: []}, {title: "x-icon icon-eye-close", searchTerms: []},
            {title: "x-icon icon-warning-sign", searchTerms: []}, {title: "x-icon icon-plane", searchTerms: []},
            {title: "x-icon icon-calendar", searchTerms: []}, {title: "x-icon icon-random", searchTerms: []},
            {title: "x-icon icon-comment", searchTerms: []}, {title: "x-icon icon-magnet", searchTerms: []},
            {title: "x-icon icon-chevron-up", searchTerms: []}, {title: "x-icon icon-chevron-down", searchTerms: []},
            {title: "x-icon icon-retweet", searchTerms: []}, {title: "x-icon icon-shopping-cart", searchTerms: []},
            {title: "x-icon icon-folder-close", searchTerms: []}, {title: "x-icon icon-folder-open", searchTerms: []},
            {title: "x-icon icon-resize-vertical", searchTerms: []}, {title: "x-icon icon-resize-horizontal", searchTerms: []},
            {title: "x-icon icon-hdd", searchTerms: []}, {title: "x-icon icon-bullhorn", searchTerms: []},
            {title: "x-icon icon-bell", searchTerms: []}, {title: "x-icon icon-certificate", searchTerms: []},
            {title: "x-icon icon-thumbs-up", searchTerms: []}, {title: "x-icon icon-thumbs-down", searchTerms: []},
            {title: "x-icon icon-hand-right", searchTerms: []}, {title: "x-icon icon-hand-left", searchTerms: []},
            {title: "x-icon icon-hand-up", searchTerms: []}, {title: "x-icon icon-hand-down", searchTerms: []},
            {title: "x-icon icon-circle-arrow-right", searchTerms: []}, {title: "x-icon icon-circle-arrow-left", searchTerms: []},
            {title: "x-icon icon-circle-arrow-up", searchTerms: []}, {title: "x-icon icon-circle-arrow-down", searchTerms: []},
            {title: "x-icon icon-globe", searchTerms: []}, {title: "x-icon icon-wrench", searchTerms: []},
            {title: "x-icon icon-tasks", searchTerms: []}, {title: "x-icon icon-filter", searchTerms: []},
            {title: "x-icon icon-briefcase", searchTerms: []}, {title: "x-icon icon-fullscreen", searchTerms: []}
        ]
    });
});